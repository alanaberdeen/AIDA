        ...
        <v-card>
            ...
            <v-list>
                <v-list-item>
                    ...
                    <input type="file" ref="uploadFile" id="uploadFile" @change="onFileChange">
                    <v-btn primary dark @click.native="chooseFile">
...
export default {
    ...
    methods: {
        ...
        addToPaper (file) {
            ...
            // Place image using the HTML element id
