...
const NumberField = (props) => {
  ...
  let {buttonProps: incrementProps} = useButton(incrementButtonProps, incrementRef);
  let {buttonProps: decrementProps} = useButton(decrementButtonProps, decrementRef);
  ...
  return (
    <div>
      ...
      <div
        {...groupProps}
        className={`${props.label ? 'mt-1' : ''} relative rounded-md shadow-sm flex`}
      >
        <input
          type="number"
          {...inputProps}
